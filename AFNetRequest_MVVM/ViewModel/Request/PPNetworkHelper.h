...
typedef enum {
    ...
    login,//登录
    banner,//广告
    newPersonPorduct,//新人专享
    jingXuanPorduct,//精选
    getSMSCode,//获取验证码
    unBind,//解绑
    personlInvest,//获取个人资产
    mbrDetail,//获取个人信息
    mbrUpdate,//提交更新信息
    personCertification,//实名认证
    accountList,//查询实名认证信息
    commonProvinces,//获取省份列表
    commonCitys,//获取城市列表
    pushDeviceInfo,//传设备信息
    RedPacket, //红包
    getCrachRedPacket,//领取现金红包
    DoInvestRequest,//投资购买
    messageRequest,//获取消息
    sms_open_acct, //开户获取验证码
    sms_charge_acct, //充值获取验证码
    queryHuifuLimit, //充值x限额信息
    memberList,//
    syncInfo,//JPush tag信息
    getVersion,//获取版本号
    inviteCode,//获取邀请码
    inviteDetail,//邀请详细
    inviteAwardList,//邀请奖励明细
    inviteFriendList,//邀请好友列表
    investDetail,//投标详情
    cashFee,//提现服务费
    detail_With_award,//获取计算收益
    bankDetail,//银行卡信息
}requestTagType;
...
/** 请求tag */
typedef void(^PPHttpRequestTag)(requestTagType  tagType);
